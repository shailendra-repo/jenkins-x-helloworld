...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
	      ...
	      <td><a href='https://hub.docker.com/_/registry/' title='A Helm chart for Docker Registry'> <img src='https://helm.twun.io/docker-registry.png' width='24px' height='24px'> docker-registry </a></td>
	      <td></td>
	      <td></td>
